...
if(isFunction("RTB_registerPref"))
{
	...
	RTB_registerPref("Spawn Rate", "Render", "$Pref::Server::RenderSpawnRate", "list Disabled 0 Low 1 Below_Normal 2 Normal 3 Above_Normal 5 High 9", "Support_Render", 4, 0, 0);
...
// This prevents the pref from showing incorrectly in the menu if updating from an old version.
if($Pref::Server::RenderSpawnRate == 4 || $Pref::Server::RenderSpawnRate == 6)
{
	$Pref::Server::RenderSpawnRate = 3;
}
