...
if(isFunction("RTB_registerPref"))
{
	...
	RTB_registerPref("Attack Mode", "Render", "$Pref::Server::RenderDamageType", "list Normal 0 Health 1 Tag 2 Haunt 3", "GameMode_Renderman_Haunting", $Pref::Server::RenderDamageType, 0, 0);
